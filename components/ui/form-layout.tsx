...
export function PageShell({
  ...
  return (
    <Card
      className={cn(
        "rounded-[2rem] border-border/80 p-4 shadow-sm sm:p-6 lg:p-8",
        className,
      )}
    >
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
        ...
        {right ? <div className="h-px w-full bg-border lg:hidden" /> : null}
...
export function ToolbarField({
  ...
  return <div className={cn("w-full sm:w-auto", className)}>{children}</div>;
}
...
export function ToolbarSearchField({
  ...
  return (
    <div
      className={cn("relative w-full sm:min-w-[20rem] sm:flex-1", className)}
    >
