...
export default function ScopeViewPage({ cnpj, id }: { cnpj: string; id: string }) {
    ...
    if (loadingScope) {
        return (
            <div className="p-4 text-muted-foreground w-full h-full flex items-center justify-center">
