...
const mockClients = [
  ...
  { cnpj: "12345678000190", razao: "Via Importadora", status: "published", lastVersion: 3 },
];
    ...
    <Card className="rounded-2xl p-4">
      <div className="mb-4 flex items-center justify-between">
        <div>
          ...
          <div className="text-sm text-muted-foreground">CNPJ como chave única • Lista mockada</div>
        </div>
          ...
          {mockClients.map((c) => (
            <TableRow key={c.cnpj} className="cursor-pointer">
              <TableCell className="font-medium">
                <Link href={`/clients/${c.cnpj}/scopes`} className="hover:underline">
                  {c.razao}
                </Link>
              </TableCell>
